...
const Heading = tw(MainHeadingTemplate)`font-openSans lg:text-left leading-tight lg:tracking-[3.6px] mb-12`;
const Description = tw(MainParagraph)`tracking-wide font-roboto mt-4 text-gray-100 mx-auto lg:mx-0 font-medium text-left max-w-3xl`;
