...
const TextColumn = styled(BaseTextColumn)(({ isRight }) => [
  isRight ? tw`mr-12 justify-start`
  : tw`ml-12 justify-end`
]);
const HeadingRow = tw.div`flex flex-col lg:flex-row justify-center items-center mb-10`;
const NumberCol = tw.div`w-1/4 flex justify-center items-center`;
...
const Heading = tw(MainHeading3Template)`text-left lg:tracking-wider`;
